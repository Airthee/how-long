<template>
  <div>
    ...
    <div class="birth-form">
      <input class="input" type="number" v-model="days" placeholder="DD" min="01" max="31" :title="$t('formDate.inputTitles.day')" />
      <span>/</span>
      <input class="input" type="number" v-model="month" placeholder="MM" min="01" max="12" :title="$t('formDate.inputTitles.month')" />
      <span>/</span>
      <input class="input" type="number" v-model="year" placeholder="YYYY" min="1900" :max="currDate.getFullYear()" :title="$t('formDate.inputTitles.year')" />
      <span>@</span>
      <input class="input" type="number" v-model="hour" placeholder="hh" min="00" max="23" :title="$t('formDate.inputTitles.hour')" />
      <span>:</span>
      <input class="input" type="number" v-model="minute" placeholder="mm" min="00" max="59" :title="$t('formDate.inputTitles.minute')" />
      <span>:</span>
      <input class="input" type="number" v-model="second" placeholder="ss" min="00" max="59" :title="$t('formDate.inputTitles.second')" />
    </div>
